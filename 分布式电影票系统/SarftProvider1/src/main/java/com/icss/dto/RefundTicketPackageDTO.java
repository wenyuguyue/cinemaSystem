...
public class RefundTicketPackageDTO implements Serializable{
	...
	public List<TicketDTO> getTlist() {
		return tlist;
	}
	public void setTlist(List<TicketDTO> tlist) {
		this.tlist = tlist;
	}
